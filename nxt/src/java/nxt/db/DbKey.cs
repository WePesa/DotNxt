...
//ORIGINAL LINE: int setPK(PreparedStatement pstmt) throws SQLException;
		int PK {set;}

//JAVA TO VB & C# CONVERTER WARNING: Method 'throws' clauses are not available in .NET:
//ORIGINAL LINE: int setPK(PreparedStatement pstmt, int index) throws SQLException;
		int setPK(PreparedStatement pstmt, int index);
...
//		{
//			base(" WHERE " + idColumn + " = ? ", idColumn, " a." + idColumn + " = b." + idColumn + " ");
//			this.idColumn = idColumn;
//		}
//
//		@Override public DbKey newKey(ResultSet rs) throws SQLException
//		{
...
//		{
//			base(" WHERE " + idColumnA + " = ? AND " + idColumnB + " = ? ", idColumnA + ", " + idColumnB, " a." + idColumnA + " = b." + idColumnA + " AND a." + idColumnB + " = b." + idColumnB + " ");
...
//		}
//
//		@Override public int setPK(PreparedStatement pstmt) throws SQLException
//		{
//			return setPK(pstmt, 1);
//		}
//
//		@Override public int setPK(PreparedStatement pstmt, int index) throws SQLException
//		{
