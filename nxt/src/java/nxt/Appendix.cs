...
//
//		@Override public final void putBytes(ByteBuffer buffer)
//		{
//			if (version > 0)
//			{
//				buffer.put(version);
...
//
//		@Override public final JSONObject getJSONObject()
//		{
...
//
//		@Override public final byte getVersion()
//		{
//			return version;
//		}
//
...
//		{
//			base(buffer, transactionVersion);
...
//		}
//
//		@Override String getAppendixName()
//		{
//			return "Message";
//		}
//
//		@Override int getMySize()
//		{
//			return 4 + message.length;
//		}
//
//		@Override void putMyBytes(ByteBuffer buffer)
//		{
//			buffer.putInt(isText ? (message.length | Integer.MIN_VALUE) : message.length);
//			buffer.put(message);
//		}
//
//		@Override void putMyJSON(JSONObject json)
//		{
//			json.put("message", isText ? Convert.toString(message) : Convert.toHexString(message));
//			json.put("messageIsText", isText);
//		}
//
//		@Override void validate(Transaction transaction) throws NxtException.ValidationException
//		{
...
//		}
//
//		@Override void apply(Transaction transaction, Account senderAccount, Account recipientAccount)
//		{
//		}
//
...
//		{
//			base(attachmentData, (JSONObject)attachmentData.get("encryptedMessage"));
//		}
//
//		public EncryptedMessage(EncryptedData encryptedData, boolean isText)
//		{
//			base(encryptedData, isText);
//		}
//
//		@Override String getAppendixName()
//		{
...
//			base.putMyJSON(encryptedMessageJSON);
...
//		{
//			base(attachmentData, (JSONObject)attachmentData.get("encryptToSelfMessage"));
//		}
//
...
//			base.putMyJSON(encryptToSelfMessageJSON);
